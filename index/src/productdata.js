let data2 = [
    {
        ...
        imgProduct1: {precess.env.PUBLIC_URL + "/img/THE_CHILD1.jpg"},
        imgProduct2: {precess.env.PUBLIC_URL + "/img/THE_CHILD2.jpg"},
        imgProduct3: {precess.env.PUBLIC_URL + "/img/THE_CHILD3.jpg"},
        imgProduct4: {precess.env.PUBLIC_URL + "/img/THE_CHILD4.jpg"},
        imgProduct5: {precess.env.PUBLIC_URL + "/img/THE_CHILD5.jpg"},
    ...
    },
    {
        ...
        genre: "Sci-fi,Pop Culture",
        artists: "Legacy Effects (Sculpt) (Mold and Cast) (Paint) (Cut and Sew) (Development) (Design), The Sideshow Design and Development Team (Development) (Design)",
        imgProduct1: {precess.env.PUBLIC_URL + "/img/AHSOKA_TANO1.jpg"},
        imgProduct2: {precess.env.PUBLIC_URL + "/img/AHSOKA_TANO2.jpg"},
        imgProduct3: {precess.env.PUBLIC_URL + "/img/AHSOKA_TANO3.jpg"},
        imgProduct4: {precess.env.PUBLIC_URL + "/img/AHSOKA_TANO4.jpg"},
        imgProduct5: {precess.env.PUBLIC_URL + "/img/AHSOKA_TANO5.jpg"},
    ...
    },
    {
        ...
        imgProduct1: {precess.env.PUBLIC_URL + "/img/ANAKIN_SKYWAKER1.jpg"},
        imgProduct2: {precess.env.PUBLIC_URL + "/img/ANAKIN_SKYWAKER2.jpg"},
        imgProduct3: {precess.env.PUBLIC_URL + "/img/ANAKIN_SKYWAKER3.jpg"},
        imgProduct4: {precess.env.PUBLIC_URL + "/img/ANAKIN_SKYWAKER4.jpg"},
        imgProduct5: {precess.env.PUBLIC_URL + "/img/ANAKIN_SKYWAKER5.jpg"},
    ...
    },
    {
        ...
        genre: "Sci-fi>Pop Culture",
        artists: "Unknown",
        imgProduct1: {precess.env.PUBLIC_URL + "/img/BOBA_FETT1.jpg"},
        imgProduct2: {precess.env.PUBLIC_URL + "/img/BOBA_FETT2.jpg"},
        imgProduct3: {precess.env.PUBLIC_URL + "/img/BOBA_FETT3.jpg"},
        imgProduct4: {precess.env.PUBLIC_URL + "/img/BOBA_FETT4.jpg"},
        imgProduct5: {precess.env.PUBLIC_URL + "/img/BOBA_FETT5.jpg"},
    ...
    },
    {
        ...
        imgProduct1: {precess.env.PUBLIC_URL + "/img/OBI-WAN_KENOBI1.jpg"},
        imgProduct2: {precess.env.PUBLIC_URL + "/img/OBI-WAN_KENOBI2.jpg"},
        imgProduct3: {precess.env.PUBLIC_URL + "/img/OBI-WAN_KENOBI3.jpg"},
        imgProduct4: {precess.env.PUBLIC_URL + "/img/OBI-WAN_KENOBI4.jpg"},
        imgProduct5: {precess.env.PUBLIC_URL + "/img/OBI-WAN_KENOBI5.jpg"},
    ...
    },
    {
        ...
        imgProduct1: {precess.env.PUBLIC_URL + "/img/GENERAL_GRIEVOUS1.jpg"},
        imgProduct2: {precess.env.PUBLIC_URL + "/img/GENERAL_GRIEVOUS2.jpg"},
        imgProduct3: {precess.env.PUBLIC_URL + "/img/GENERAL_GRIEVOUS3.jpg"},
        imgProduct4: {precess.env.PUBLIC_URL + "/img/GENERAL_GRIEVOUS4.jpg"},
        imgProduct5: {precess.env.PUBLIC_URL + "/img/GENERAL_GRIEVOUS5.jpg"},
    ...
    },
    {
        ...
        imgProduct1: {precess.env.PUBLIC_URL + "/img/SCOUT_TROOPER1.jpg"},
        imgProduct2: {precess.env.PUBLIC_URL + "/img/SCOUT_TROOPER2.jpg"},
        imgProduct3: {precess.env.PUBLIC_URL + "/img/SCOUT_TROOPER3.jpg"},
        imgProduct4: {precess.env.PUBLIC_URL + "/img/SCOUT_TROOPER4.jpg"},
        imgProduct5: {precess.env.PUBLIC_URL + "/img/SCOUT_TROOPER5.jpg"},
    ...
    },
    {
        ...
        genre: "Sci-fi, Pop Culture",
        artists: "Lok Ho (Paint), JC. Hong (Art Direction)",
        imgProduct1: {precess.env.PUBLIC_URL +"/img/HAN_SOLO1.jpg"},
        imgProduct2: {precess.env.PUBLIC_URL +"/img/HAN_SOLO2.jpg"},
        imgProduct3: {precess.env.PUBLIC_URL +"/img/HAN_SOLO3.jpg"},
        imgProduct4: {precess.env.PUBLIC_URL +"/img/HAN_SOLO4.jpg"},
        imgProduct5: {precess.env.PUBLIC_URL +"/img/HAN_SOLO5.jpg"},
    ...
    },
    {
        ...
        imgProduct1: {precess.env.PUBLIC_URL + "/img/DARTH_VADER21.jpg"},
        imgProduct2: {precess.env.PUBLIC_URL + "/img/DARTH_VADER22.jpg"},
        imgProduct3: {precess.env.PUBLIC_URL + "/img/DARTH_VADER23.jpg"},
        imgProduct4: {precess.env.PUBLIC_URL + "/img/DARTH_VADER24.jpg"},
        imgProduct5: {precess.env.PUBLIC_URL + "/img/DARTH_VADER25.jpg"},
    ...
    },
    {
        ...
        genre: "Sci-fi Pop>Culture",
        artists: "Unknown",
        imgProduct1: {precess.env.PUBLIC_URL + "/img/PURGE_TROOPER1.jpg"},
        imgProduct2: {precess.env.PUBLIC_URL + "/img/PURGE_TROOPER2.jpg"},
        imgProduct3: {precess.env.PUBLIC_URL + "/img/PURGE_TROOPER3.jpg"},
        imgProduct4: {precess.env.PUBLIC_URL + "/img/PURGE_TROOPER4.jpg"},
        imgProduct5: {precess.env.PUBLIC_URL + "/img/PURGE_TROOPER5.jpg"},
